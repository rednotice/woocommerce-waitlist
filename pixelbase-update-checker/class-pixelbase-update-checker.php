...
if ( ! class_exists( 'Pixelbase_Update_Checker' ) ) {

    /**
     * Pixelbase_Update_Checker adds license checked updates to your
     * WordPress theme or plugin, using the PixelBase Licence Manager plugin
     * and its API.
     *
     ...
     * at https://pixelbase.co/license-manager
     *
     * @author PixelBase
     * @url https://pixelbase.co
     */
    class Pixelbase_Update_Checker {
        ...
        /**
         * The slug name for the parent menu (or the file name of a standard WordPress admin page). Configured in the class's constructor.
         *
        ...
        public function __construct( $product_id, $product_name, $text_domain, $api_url,
                                     $type = 'theme', $plugin_file = '', $parent_slug = '') {
            // Store setup data
        ...
        public function add_license_settings_fields() {
            ...
            add_settings_field(
                ...
                __( 'License email address', $this->text_domain ),
            ...
            if ( ! $this->get_license_key() ) {
                ...
                ?>
                    <div class="update-nag">
                        ...
                        <p>
                            <?php if( $this->parent_slug !== '' ) : ?>
                                <a href="<?php echo admin_url( 'admin.php?page=' . $this->get_settings_page_slug() ); ?>">
